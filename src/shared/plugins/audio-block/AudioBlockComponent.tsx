...
import { type WaveformCanvas, drawWaveform } from "./waveform";
  ...
  return (
    ...
    <div
      className={clsx(
        ...
        "border bg-surface-2",
        isSelected
          ? "border-accent-2 shadow-accent-strong/20 shadow-lg"
          : waveformStatus === "error"
            ? "border-danger-2/60"
            : "border-tint-2 hover:border-tint-3"
      )}
    ...
    >
      ...
      <div className="flex items-center gap-2.5 mb-2.5">
        ...
        <div className="flex-1 min-w-0 ">
          {titleEditing ? (
            <input
              ...
              autoFocus
              className={clsx(
                "w-full text-base font-semibold border-none outline-none px-0.5",
                "bg-surface-4/50 text-ink-2"
              )}
            ...
            <div
              className={clsx(
                "text-[13px] font-semibold truncate cursor-text",
                "text-ink hover:bg-surface-4/50"
              )}
        ...
        <button
          ...
          className={clsx(
            "shrink-0 w-5.5 h-5.5 rounded-full border-none cursor-pointer flex items-center justify-center p-0",
            "opacity-0 group-hover:opacity-100 transition-[opacity,background] duration-150",
            "bg-tint hover:bg-danger-soft-2 hover:text-danger-strong"
          )}
      ...
      >
        ...
        <div
          ...
          className="absolute top-0 left-0 h-full pointer-events-none w-full bg-accent-2/10 border-r-2 border-r-accent-2"
          style={{ width: "0%" }}
        />
        {waveformStatus !== "ready" && (
          <div
            className={clsx(
              ...
              waveformStatus === "error" ? "text-danger-2" : "text-ink-4"
            )}
          >

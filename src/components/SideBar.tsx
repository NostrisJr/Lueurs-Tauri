        ...
        <div className="flex flex-col h-full overflow-hidden">
            ...
            <div className="shrink-0">
                ...
                <div className="px-4 py-1.5 border-b border-gray-200">
                    <p className="text-xs text-gray-400 truncate" title={folderPath ?? "Aucun dossier sélectionné"}>
                ...
                <div className="px-3 py-2 border-b border-gray-200">
                    <div className="flex items-center gap-2 bg-white border border-gray-200 rounded-md px-2.5 py-1.5 text-gray-400 focus-within:border-gray-400 transition-colors">
                        ...
                        />
                        {search && (
                            <button type="button" onClick={() => setSearch("")} className="text-gray-300 hover:text-gray-500 text-xs cursor-pointer">✕</button>
                        )}
                    </div>
                </div>
            </div>
            ...
            <div className="flex-1 overflow-y-auto scroll-thin">
                {loading && <p className="px-4 py-4 text-xs text-center text-gray-400">Chargement...</p>}
                {error && <p className="px-4 py-4 text-xs text-center text-red-400">{error}</p>}

      ...
      {onRecord && (
        <>
          ...
          <button
            ...
            onClick={onRecord}
            className="px-2 py-0.5 rounded text-xs font-medium text-gray-500 hover:bg-gray-100 hover:text-gray-800 active:bg-gray-200 transition-colors cursor-default select-none"
          >
            ⏺
          </button>
        </>
